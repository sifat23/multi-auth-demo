       ...
       <div class="wrapper">
                                ...
                                <div class="header-search-cart">
                                    ...
                                    <div class="header-cart common-style">
                                        <button class="sidebar-trigger">
                                            <span class="ion-bag"><i class="fas fa-shopping-cart"></i></span>
                                        </button>
                                    </div>
                                    <div class="header-sidebar common-style">
                                        <button class="header-navbar-active">
                                            <span class="ion-navicon"><i class="fas fa-bars"></i></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="cur-lang-acc-active">
                <div class="wrap-sidebar">
                    ...
                    <div class="cur-lang-acc-all">
                        ...
                        <div class="single-currency-language-account">
                            <div class="cur-lang-acc-title">
                                <h4>Language: <span><img src="{{ asset('img/icon-img/english.png') }}" alt=""> English </span></h4>
                            </div>
                            <div class="cur-lang-acc-dropdown">
                                <ul>
                                    <li><a href="#"><img src="{{ asset('img/icon-img/english.png') }}" alt=""> English </a></li>
                                    <li><a href="#"><img src="{{ asset('img/icon-img/es.png') }}" alt=""> spanish </a></li>
                                    <li><a href="#"><img src="{{ asset('img/icon-img/fr.png') }}" alt=""> french </a></li>
                                    <li><a href="#"><img src="{{ asset('img/icon-img/ge.png') }}" alt=""> german </a></li>
                                    <li><a href="#"><img src="{{ asset('img/icon-img/es.png')}}" alt=""> spanish </a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="slider-area">
                <div class="slider-active owl-carousel">
                    <div class="single-slider single-slider-hm1 bg-img ptb-260" style="background-image: url(img/slider/1.jpg)">
                        <div class="container">
                    ...
                    <div class="single-slider single-slider-hm1 bg-img slider-content-style-1 ptb-260" style="background-image: url(img/slider/8.jpg)">
                        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 col-12">
                            <div class="single-banner mb-30">
                                <a href="shop-grid-view-sidebar.html"><img src="{{ asset('img/banner/1.jpg') }}" alt=""></a>
                        ...
                        <div class="d-sm-none d-lg-block col-lg-6 col-12">
                            <div class="single-banner mb-30">
                                <a href="shop-grid-view-sidebar.html"><img src="{{ asset('img/banner/2.jpg') }}" alt=""></a>
                        ...
                        <div class="col-md-6 col-lg-3 col-12">
                            <div class="single-banner mb-30">
                                <a href="shop-grid-view-sidebar.html"><img src="{{ asset('img/banner/3.jpg') }}" alt=""></a>
                                ...
                                <div class="row">
                                    <div class="product-slider-active owl-carousel">
                                        ...
                                        <div class="col-md-3 col-lg-3 col-sm-4">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="#"><img src="{{ asset('img/product/7.jpg') }}" alt=""></a>
                                                    <span>sale</span>
                                                    <div class="product-action">
                                                        <a title="Wishlist" class="animate-left" href="#"><i class="ion-ios-heart-outline"></i></a>
                                                        <a title="Quick View" data-toggle="modal" data-target="#exampleModal" class="animate-right" href="#"><i class="ion-ios-eye-outline"></i></a>
                                        ...
                                        <div class="col-md-3 col-lg-3 col-sm-4">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="#"><img src="{{ asset('img/product/8.jpg') }}" alt=""></a>
                                                    <div class="product-action">
                                                        <a title="Wishlist" class="animate-left" href="#"><i class="ion-ios-heart-outline"></i></a>
                                                        <a title="Quick View" data-toggle="modal" data-target="#exampleModal" class="animate-right" href="#"><i class="ion-ios-eye-outline"></i></a>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="product-slider-active owl-carousel">
                                        ...
                                        <div class="col-md-3 col-lg-3 col-sm-4">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="#"><img src="/imgproduct/10.jpg" alt=""></a>
                                                    <div class="product-action">
                                                        <a title="Wishlist" class="animate-left" href="#"><i class="ion-ios-heart-outline"></i></a>
                                                        <a title="Quick View" data-toggle="modal" data-target="#exampleModal" class="animate-right" href="#"><i class="ion-ios-eye-outline"></i></a>
                                                    </div>
            ...
            <div class="clickable-mainmenu-btn">
                <a class="clickable-mainmenu-active" href="#"><i class="fas fa-bars"></i></a>
            </div>
